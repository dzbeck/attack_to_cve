...
| CWE-22: [Path Traversal](https://cwe.mitre.org/data/definitions/22.html) | [T1202]() (Indirect Command Execution)  | see [Keyword-based Mapping](#keyword-based-mapping) (*file-related* content) | see [Keyword-based Mapping](#keyword-based-mapping) (*file-related* content) |  This mapping also applies to CWE-36: [Absolute Path Traversal](https://cwe.mitre.org/data/definitions/36.html) and CWE-23 [Relative Path Traversal](https://cwe.mitre.org/data/definitions/23.html) |
| CWE-20: [Improper Input Validation](https://cwe.mitre.org/data/definitions/918.html) |  |  |  |  |
