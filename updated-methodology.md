...
Vulnerabilities of the same type will often have the same or similar technique mappings. **Table 1** lists the most common vulnerability types based on CWE (in order), which are taken from [[1]](#1) (see the *Top 25 most dangerous CWE codes as reflected in CVEs 2018-2022* graphic), as well as the well-known higher-level types (CWE classes/categories) in the [CWE-699 (Software Development)](https://cwe.mitre.org/data/definitions/699.html) and [CWE-1000 (Research Concepts)](https://cwe.mitre.org/data/definitions/1000.html) views. 
...
| CWE-310: [Cryptographic Issues](https://cwe.mitre.org/data/definitions/310.html) | |  |  |  | CWE-310 is a CWE catagory. |
