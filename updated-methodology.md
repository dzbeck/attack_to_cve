...
| | [T1189](https://attack.mitre.org/techniques/T1189) (Drive-by Compromise) |  | Vulnerable web **browsers** can be targets of drive-by compromises. |
...
| **Operating System** (e.g., kernel, shell) | [T1574](https://attack.mitre.org/techniques/T1574) (Hijack Execution Flow) | [T1499.004](https://attack.mitre.org/techniques/T1499/004) (Endpoint Denial of Service: Application or System Exploitation) | For example, a race condition in the kernel can be exploited to elevate privilege or crash the system (DoS). |
